interface CounterLimitTemplateParams {
  ...
  limit: number;
  testProbes?: { partNumber: string; qty: number }[];
}
...
export function counterLimitTemplate(
  ...
  const overContacts =
    currentContacts > limit ? currentContacts - limit : 0;

  /** sort probes by quantity DESC */
...
<html>
  <head>
    ...
    <title>Counter Limit Reached</title>
      ...
      <div class="customWidth">
        <div class="card">
          <div class="header-bar">
            ...
            <p class="header-subtitle">Counter limit reached</p>
          </div>
          ...
          <p style="font-size: 0.95rem; margin: 0 0 0.75rem 0;">
            The <strong>contact limit</strong> has been reached for the following project:
          </p>
          ...
          <table class="metrics-table">
            ...
            <tbody>
              <tr>
                <td>Current number of contacts</td>
                <td>${currentContacts}</td>
              </tr>
              <tr>
                <td>Limit</td>
                <td>${limit}</td>
          ...
          <p style="font-size: 0.9rem; margin-top: 1rem;">
            Please stop using this fixture with the current probes and plan an immediate maintenance.
          </p>
